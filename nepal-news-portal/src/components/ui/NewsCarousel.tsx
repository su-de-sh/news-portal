  ...
  if (!items.length) {
    return (
      <div className="carousel-container h-96 bg-muted animate-pulse rounded-2xl flex items-center justify-center">
        <span className="text-muted-foreground">No featured news available</span>
      </div>
    );
  }
          ...
          <div className="space-y-4 animate-fade-in-up">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-white/80 text-sm">
                {formatRelativeTime(currentItem.publishedAt instanceof Date ? currentItem.publishedAt : new Date(currentItem.publishedAt))}
              </span>
            </div>
